...
Use in your ColBERT config (place this file in the run dir, i.e. the sbatch container-workdir):

    trainer:
      callbacks:
        - class_path: freeze_diag.FreezeDiagnostics
          init_args:
            max_steps: 300

If jsonargparse cannot import it, prepend the run dir to the path in your sbatch before
`lightning-ir fit`:  `export PYTHONPATH="$PWD:$PYTHONPATH"`.
"""
